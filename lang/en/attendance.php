...
$string['defaultsessionminuteslength'] = 'Minute interval length';
$string['defaultsessionminuteslength_desc'] = 'Reduce the available minutes selection (e.g. 5 => 0,5,10,15,20,25,30,35,40,45,50,55 or 15 => 0,15,30,45).<br> If defaultsessiontimeend or defaultcustomsessionblocks are not in the selection then it resets the interval to 1.';
$string['defaultsessiontimesetenabled'] = 'Current time set for creating sessions';
$string['defaultsessiontimesetenabled_desc'] = 'Enables to set the current time to time selection with hours and minutes.';
$string['defaultsessiontimeendsetenabled'] = 'Enable default end time set';
$string['defaultsessiontimeendsetenabled_desc'] = 'Enable automatic set end time based on defaultsessiontimeend or defaultsessionblocks';
$string['defaultsessiontimeend'] = 'Session end (minutes)';
$string['defaultsessiontimeend_desc'] = 'How long is the default lesson.';
$string['defaultcustomsessionblocks'] = 'Custom time blocks for sessions';
$string['defaultcustomsessionblocks_desc'] = 'Ignores the defaultsessiontimeend and round to given time blocks instead. Define custom time blocks for sessions 00:00-00:00 (new line for each session) e.g. <br> 09:30-11:15 <br> 11:35-13:05 <br> 13:45-15:15';
